...
$_SESSION['lecture_id'] = (int)$_POST['lecture_id'];
$_SESSION['test_me'] = 90;
$header = "";
...
//get the total number of students and store this information in a session
$stud_count = "";
$sql_count_students = "SELECT COUNT(c.stud_number) AS stud_count
...
$result_count_students = mysqli_query($link, $sql_count_students);
if(mysqli_num_rows($result_count_students)>0)
{
    while($row_count_students = mysqli_fetch_assoc($result_count_students))
    {
        $stud_count = "Total Students " . $row_count_students['stud_count'];
    }
}
else
{
    $stud_count = "Total Students 0";
}
...
$sql = "
  ...
  if(mysqli_num_rows($result)>0)
  {
    ...
    echo heavy_button($staff_number, "staff_number", $lecture_id,"lecture_id", $module_code, "module_code", "group_students", "Group Students", "test_grouping.php", "submit_button");
