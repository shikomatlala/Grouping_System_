...
if(isset($_POST['submit']))
{
    ...
    else
    {
      ...
      $input->set_input("text", "id_nr", $student->get_id(), "ID Number", "input_");
      $input_wrapper .= $label->get_label() . "<br>\n";
      $input_wrapper .= $input->get_input_text() . "<br>\n";
      //first _name
      ...
      $input->set_input("text", "phone", $student->get_phone(), "Phone Number", "input_");
      $input_wrapper .= $label->get_label() . "<br>\n";
      $input_wrapper .= $input->get_input_text() . "<br>\n";
      //first _name
