...
if(mysqli_num_rows($result)>0)
{
    while($row = mysqli_fetch_assoc($result))
    {
        ...
        $label->set_label("stud_num", "Student Number:&nbsp;&nbsp;&nbsp;&nbsp;" . $row['stud_number'], "view_like_ptag");
        $input_wrapper .= $label->get_label() . "";
        $input->set_input("hidden", "stud_number", $row['stud_number'], "", "");
        $input_wrapper .= $input->get_input();
        //ID Number
        $label->set_label("id_nr", "ID Number:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" .  $row['id_nr'], "view_like_ptag");
        $input_wrapper .= $label->get_label() . "";
        //Show the Gender
        ...
        $label->set_label("id_nr", "Sex:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . $gender, "view_like_ptag");
        $input_wrapper .= $label->get_label() . "";
        //Email
        $label->set_label("email", "Email Address:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . $row['email'], "view_like_ptag");
        $input_wrapper .= $label->get_label() . "<hr>\n";
        //First Name
        $label->setLabel("first_name", "First Name", "", "lblFName");
        $input->setInput("text", "first_name", $student->get_firstname(), "First Name", "input_", "fname", "oninput", "validateName(this.id, 'lblFName')");
        $input_wrapper .= $label->getLabel() . "<br>\n";
        $input_wrapper .= $input->getInput() . "<br><br>\n";
        //Last Name
        $label->setLabel("last_name", "Last Name", "", "lblLName");
        $input->setInput("text", "last_name", $student->get_lastname(), "Last Name", "input_", "lname", "oninput", "validateName(this.id, 'lblLName')");
        $input_wrapper .= $label->getLabel() . "<br>\n";
        $input_wrapper .= $input->getInput() . "<br><br>\n";
        //Phone Number
        $label->set_label_("phone", "Phone Number", "", "lblPhone");
        $input->setInput("text", "phone",$row['phone'], "e.g. 0765870538", "input_", "phone", "oninput", "validatePhone()");
        ...
        $input->set_input("submit","udpate", "Update", "","update_button");
