...
class Input
{
  ...
  public function set_input_($type, $name, $value, $place_holder, $class, $id,  $event_type, $event)
  {
    $this->type = $type;
    $this->name = $name;
    $this->value = $value;
  ...
  {
    //echo $this->type;
    $out = "<input id=\"$this->id\" $this->event_type=\"$this->event\" class=\"$this->class\" type=\"$this->type\" name=\"$this->name\" value=\"$this->value\" >" ;
    return $out;
  }
}
class Label
