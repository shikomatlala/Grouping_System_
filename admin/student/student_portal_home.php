...
if(mysqli_num_rows($result)>0)
{
  ...
  while($row = mysqli_fetch_assoc($result))
  {
    ...
    $input->set_input("submit", "delete_student", "Delete", "", "delete_button", "delete_student", "onclick", "verify_delete()");
    $inputs .= $input->get_input();
...
$input->set_input("text", "stud_number", "", "", "input_", "search_stud_input", "onchange", "validate_search()");
$inputs .= $input->get_input();
$input->set_input("submit", "search_student", "Search Student", "", "submit_button", "search_stud_button", "", "");
$inputs .= $input->get_input();
$form_out = $form->get_form_wrapper($inputs);
$search_student .= "\n\t\t" . $form_out;
echo $search_student;
